...
public static unsafe partial class SDL
{
    ...
    // Explicit UTF-8 helpers (used by generated wrappers)
    public static IntPtr Utf8StringToNative(string? managed)
    {
        if (managed is null) { return IntPtr.Zero; }
    ...
    public static string PtrToStringUtf8(IntPtr nativePtr)
    {
        ...
        int len = 0;
        while (Marshal.ReadByte(nativePtr, len) != 0) { len++; }
    ...
    // Helpers: marshal native uint32 arrays to managed collections (works with IntPtr + count returned by SDL)
    // - Uses Marshal.Copy(IntPtr, int[], ...) because Marshal.Copy has no uint[] overload.
    // - Safe for .NET Standard 2.0.
    public static System.Collections.Generic.List<uint> PtrToUint32List(IntPtr nativePtr, int count)
    {
        ...
        if (nativePtr == IntPtr.Zero || count <= 0) { return list; }
    ...
    {
        if (nativePtr == IntPtr.Zero || count <= 0) { return Array.Empty<uint>(); }
    ...
    // Returns a Span<uint> that views the native memory. Use with care: the returned span points to unmanaged memory
    // and must not outlive the native buffer.
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_LoadWAV(string path, out SDL_AudioSpec spec, out IntPtr audio_buf, out uint audio_len);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetAudioFormatName(SDL_AudioFormat format);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetPixelFormatName(SDL_PixelFormat format);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_SetPaletteColors(IntPtr palette, Span<SDL_Color> colors, int firstcolor, int ncolors);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_GetRectEnclosingPoints(Span<SDL_Point> points, int count, ref SDL_Rect clip, out SDL_Rect result);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_GetRectEnclosingPointsFloat(Span<SDL_FPoint> points, int count, ref SDL_FRect clip, out SDL_FRect result);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_Surface* SDL_CreateSurfaceFrom(int width, int height, SDL_PixelFormat format, IntPtr pixels, int pitch);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_Surface* SDL_ConvertSurfaceAndColorspace(IntPtr surface, SDL_PixelFormat format, IntPtr palette, SDL_Colorspace colorspace, uint props);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetCameraDriver(int index);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetCurrentCameraDriver();
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetCameraName(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetSensorNameForID(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetSensorName(IntPtr sensor);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetJoystickNameForID(uint instance_id);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetJoystickPathForID(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetJoystickName(IntPtr joystick);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetJoystickPath(IntPtr joystick);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetJoystickSerial(IntPtr joystick);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AddGamepadMapping(string mapping);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AddGamepadMappingsFromIO(IntPtr src, SDLBool closeio);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AddGamepadMappingsFromFile(string file);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadMappingForGUID(SDL_GUID guid);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadMapping(IntPtr gamepad);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadNameForID(uint instance_id);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadPathForID(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadMappingForID(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadName(IntPtr gamepad);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadPath(IntPtr gamepad);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadSerial(IntPtr gamepad);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadStringForType(SDL_GamepadType type);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GamepadAxis SDL_GetGamepadAxisFromString(string str);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadStringForAxis(SDL_GamepadAxis axis);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadStringForButton(SDL_GamepadButton button);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadAppleSFSymbolsNameForButton(IntPtr gamepad, SDL_GamepadButton button);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGamepadAppleSFSymbolsNameForAxis(IntPtr gamepad, SDL_GamepadAxis axis);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetKeyboardNameForID(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetScancodeName(SDL_Scancode scancode);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_Scancode SDL_GetScancodeFromName(string name);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetKeyName(uint key);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetMouseNameForID(uint instance_id);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetTouchDeviceName(ulong touchID);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_PeepEvents(Span<SDL_Event> events, int numevents, SDL_EventAction action, uint minType, uint maxType);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGPUDriver(int index);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetGPUDeviceDriver(IntPtr device);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GPUShaderFormat SDL_GetGPUShaderFormats(IntPtr device);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateGPUComputePipeline(IntPtr device, in SDL_GPUComputePipelineCreateInfo createinfo);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateGPUGraphicsPipeline(IntPtr device, in SDL_GPUGraphicsPipelineCreateInfo createinfo);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateGPUTransferBuffer(IntPtr device, in SDL_GPUTransferBufferCreateInfo createinfo);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_BeginGPURenderPass(IntPtr command_buffer, Span<SDL_GPUColorTargetInfo> color_target_infos, uint num_color_targets, in SDL_GPUDepthStencilTargetInfo depth_stencil_target_info);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUVertexBuffers(IntPtr render_pass, uint first_slot, Span<SDL_GPUBufferBinding> bindings, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUIndexBuffer(IntPtr render_pass, in SDL_GPUBufferBinding binding, SDL_GPUIndexElementSize index_element_size);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUVertexSamplers(IntPtr render_pass, uint first_slot, Span<SDL_GPUTextureSamplerBinding> texture_sampler_bindings, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUVertexStorageTextures(IntPtr render_pass, uint first_slot, Span<IntPtr> storage_textures, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUVertexStorageBuffers(IntPtr render_pass, uint first_slot, Span<IntPtr> storage_buffers, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUFragmentSamplers(IntPtr render_pass, uint first_slot, Span<SDL_GPUTextureSamplerBinding> texture_sampler_bindings, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUFragmentStorageTextures(IntPtr render_pass, uint first_slot, Span<IntPtr> storage_textures, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUFragmentStorageBuffers(IntPtr render_pass, uint first_slot, Span<IntPtr> storage_buffers, uint num_bindings);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_BeginGPUComputePass(IntPtr command_buffer, Span<SDL_GPUStorageTextureReadWriteBinding> storage_texture_bindings, uint num_storage_texture_bindings, Span<SDL_GPUStorageBufferReadWriteBinding> storage_buffer_bindings, uint num_storage_buffer_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUComputePipeline(IntPtr compute_pass, IntPtr compute_pipeline);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUComputeSamplers(IntPtr compute_pass, uint first_slot, Span<SDL_GPUTextureSamplerBinding> texture_sampler_bindings, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUComputeStorageTextures(IntPtr compute_pass, uint first_slot, Span<IntPtr> storage_textures, uint num_bindings);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_BindGPUComputeStorageBuffers(IntPtr compute_pass, uint first_slot, Span<IntPtr> storage_buffers, uint num_bindings);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_UploadToGPUTexture(IntPtr copy_pass, in SDL_GPUTextureTransferInfo source, in SDL_GPUTextureRegion destination, SDLBool cycle);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_UploadToGPUBuffer(IntPtr copy_pass, in SDL_GPUTransferBufferLocation source, in SDL_GPUBufferRegion destination, SDLBool cycle);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_CopyGPUTextureToTexture(IntPtr copy_pass, in SDL_GPUTextureLocation source, in SDL_GPUTextureLocation destination, uint w, uint h, uint d, SDLBool cycle);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_CopyGPUBufferToBuffer(IntPtr copy_pass, in SDL_GPUBufferLocation source, in SDL_GPUBufferLocation destination, uint size, SDLBool cycle);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_DownloadFromGPUTexture(IntPtr copy_pass, in SDL_GPUTextureRegion source, in SDL_GPUTextureTransferInfo destination);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_DownloadFromGPUBuffer(IntPtr copy_pass, in SDL_GPUBufferRegion source, in SDL_GPUTransferBufferLocation destination);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_WaitForGPUFences(IntPtr device, SDLBool wait_all, Span<IntPtr> fences, uint num_fences);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetRenderDriver(int index);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_CreateWindowAndRenderer(string title, int width, int height, SDL_WindowFlags window_flags, out IntPtr window, out IntPtr renderer);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)] public static extern string SDL_GetRendererName(IntPtr renderer);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_Texture* SDL_CreateTexture(IntPtr renderer, SDL_PixelFormat format, SDL_TextureAccess access, int w, int h);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_RenderTextureAffine(IntPtr renderer, IntPtr texture, in SDL_FRect srcrect, in SDL_FPoint origin, in SDL_FPoint right, in SDL_FPoint down);
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDLBool SDL_RenderGeometry(IntPtr renderer, IntPtr texture, Span<SDL_Vertex> vertices, int num_vertices, Span<int> indices, int num_indices); // WARN_UNKNOWN_POINTER_PARAMETER
